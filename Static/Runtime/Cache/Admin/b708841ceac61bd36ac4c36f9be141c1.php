<?php if (!defined('THINK_PATH')) exit();?><div class="modal inmodal fade" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <link href="http://localhost/base/Static/Resource/css/docs.min.css" rel="stylesheet">
    <script>
        $(function () {
            $("ul.bs-glyphicons-list > li").on('click', function () {
