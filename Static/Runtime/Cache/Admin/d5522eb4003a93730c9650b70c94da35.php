...
<html lang="zh-CN">
    ...
    <body class="gray-bg">
        <div class="middle-box text-center loginscreen animated fadeInDown">
            ...
            <form id="login" class="m-t-lg" role="form" action="<?php echo U('login');?>" method='post' data-ajax="true" data-tips="正在登录..." onSubmit="return false;">
                <div class="form-group">
                    <input type="text" class="form-control" name='name' placeholder="Username" maxlength="20" autocomplete="off" pattern="/^\w+$/"  required="">
                </div>
                <div class="form-group">
